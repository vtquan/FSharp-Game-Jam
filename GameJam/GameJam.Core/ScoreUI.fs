...
module ScoreUI =
    ...
    let init currentTime bestTime (scene : Scene) =
        ...
        { empty with CurrentTime = currentTime; BestTime = bestTime; Page = page }
    ...
    let view (model : Model) (deltaTime : float32) =
        ...
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time3").Text <- sprintf "%s" <| model.BestTime.Item(2).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time4").Text <- sprintf "%s" <| model.BestTime.Item(3).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time5").Text <- sprintf "%s" <| model.BestTime.Item(4).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time6").Text <- sprintf "%s" <| model.BestTime.Item(5).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time7").Text <- sprintf "%s" <| model.BestTime.Item(6).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time8").Text <- sprintf "%s" <| model.BestTime.Item(7).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time9").Text <- sprintf "%s" <| model.BestTime.Item(8).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time10").Text <- sprintf "%s" <| model.BestTime.Item(9).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time11").Text <- sprintf "%s" <| model.BestTime.Item(10).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time12").Text <- sprintf "%s" <| model.BestTime.Item(11).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time13").Text <- sprintf "%s" <| model.BestTime.Item(12).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time14").Text <- sprintf "%s" <| model.BestTime.Item(13).ToString("hh\:mm\:ss\:fff")
        //bestTimeCounter.FindVisualChildOfType<TextBlock>("Time15").Text <- sprintf "%s" <| model.BestTime.Item(14).ToString("hh\:mm\:ss\:fff")
        ()
        //let bestTimeCounter = model.Page.RootElement.FindVisualChildOfType<Grid>("BestTimes");
