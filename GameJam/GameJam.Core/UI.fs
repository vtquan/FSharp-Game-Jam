...
module ScoreUI =
    ...
    let view (model : Model) (deltaTime : float32) =
        ...
        timeCounter.FindVisualChildOfType<TextBlock>("Time3").Text <- sprintf "%s" <| model.CurrentTime.Item(3).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time4").Text <- sprintf "%s" <| model.CurrentTime.Item(4).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time5").Text <- sprintf "%s" <| model.CurrentTime.Item(5).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time6").Text <- sprintf "%s" <| model.CurrentTime.Item(6).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time7").Text <- sprintf "%s" <| model.CurrentTime.Item(7).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time8").Text <- sprintf "%s" <| model.CurrentTime.Item(8).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time9").Text <- sprintf "%s" <| model.CurrentTime.Item(9).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time10").Text <- sprintf "%s" <| model.CurrentTime.Item(10).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time11").Text <- sprintf "%s" <| model.CurrentTime.Item(11).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time12").Text <- sprintf "%s" <| model.CurrentTime.Item(12).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time13").Text <- sprintf "%s" <| model.CurrentTime.Item(13).ToString("hh\:mm\:ss\:fff")
        timeCounter.FindVisualChildOfType<TextBlock>("Time14").Text <- sprintf "%s" <| model.CurrentTime.Item(14).ToString("hh\:mm\:ss\:fff")
